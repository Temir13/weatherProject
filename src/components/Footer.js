                    ...
                    <div className={s.LinksDownContainer}>
                        <div className={s.LinksDownBlock}>
                            ...
                            <div className={s.DownProject}>
                                <a href='https://instagram.com/lazarev_temir?igshid=YmMyMTA2M2Y=' className={s.DownLazarus}> Темира Лазарев</a>
                            ...
                            <div className={s.DownProjectt}>
                            <a href='https://instagram.com/siuus.2001?igshid=YmMyMTA2M2Y=' className={s.DownKesha}> GROUP   SIS-2001</a>
                            </div>
                        </div>
                    </div>            
                </div>
